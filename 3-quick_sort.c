...
/**
 * lomuto_recursive_sort - Implement the quicksort algorithm through recursion.
...
if (right - left > 0)
{
	...
	lomuto_recursive_sort(array, size, left, part - 1);
	lomuto_recursive_sort(array, size, part + 1, right);
}
}
